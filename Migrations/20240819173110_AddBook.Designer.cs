...
namespace Backend.Migrations
{
    ...
    [Migration("20240819173110_AddBook")]
            ...
            modelBuilder.Entity("Backend.Models.DifficultLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(656),
                            Description = "Nhận biết, nhắc lại được kiến thức, kĩ năng đã học.",
                            Name = "Nhận biết",
                            UpdatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(667)
                        },
                        new
                        {
                            DifficultLevelId = new Guid("5e0d9a7a-e16d-4e54-be4d-839fa04f5a37"),
                            CreatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(719),
                            Description = "Hiểu kiến thức, kĩ năng đã học. trình bày, giải thích được kiến thức theo cách hiểu của cá nhân.",
                            Name = "Đọc hiểu",
                            UpdatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(720)
                        },
                        new
                        {
                            DifficultLevelId = new Guid("09593f78-2de4-48dc-9d79-72e72fa33607"),
                            CreatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(736),
                            ...
                            Name = "Vận dụng",
                            UpdatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(736)
                        },
                        new
                        {
                            DifficultLevelId = new Guid("47bd5bef-43b8-48a1-8495-b2a09d2f1177"),
                            CreatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(751),
                            ...
                            Name = "Vận dụng cao",
                            UpdatedAt = new DateTime(2024, 8, 20, 0, 31, 10, 200, DateTimeKind.Local).AddTicks(751)
                        });
                });
